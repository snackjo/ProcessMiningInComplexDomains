...
import tagger_module.cook
import chess.engine
from tagger_module.zugzwang import zugzwang
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(prog='tagger_module.py', description='automatically tags lichess puzzles')
